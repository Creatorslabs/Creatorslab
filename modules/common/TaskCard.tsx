    ...
    >
      ...
      <div className="flex flex-col py-3 gap-2">
        ...
        <div className="flex justify-between">
          <div className="flex flex-row gap-1 rounded-md bg-[#5D3FD1] text-white p-2 text-sm items-center whitespace-no-wrap">
          ...
          <div className="flex flex-row gap-1 rounded-md bg-[#222222] text-white p-2 text-sm items-center">
            <FaHeart /> {task.participants.length} of {task.maxParticipants}{" "}
            Joined
          </div>
        </div>
      </div>
