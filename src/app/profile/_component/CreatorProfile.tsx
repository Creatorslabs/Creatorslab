            ...
            <div className="border-[0.5px] border-[#606060] p-4 sm:p-8 rounded-xl mt-8">
              <div className="mb-8">
                ...
                <div className="flex flex-col gap-6">
                  {user.twitter ? (
                    <div className="flex justify-between items-center border-[#606060] border rounded-lg p-2 sm:p-5 w-full max-w-[450px]">
                      ...
                      <button
                        className="bg-[#F7F8F9] dark:bg-[#242424] dark:text-whiteh-fit py-1 px-2 rounded-sm flex gap-2 items-center"
                        disabled
                      >
                    ...
                    <div className="flex justify-between items-center border-[#606060] border rounded-lg p-2 sm:p-5 w-full max-w-[450px]">
                      ...
                      <button
                        className="p-3 rounded-lg bg-[#F7F8F9] dark:bg-[#242424] dark:text-white"
                        onClick={linkTwitter}
                      >
                        <IoArrowForward />
                      </button>
                  ...
                  {user.discord ? (
                    <div className="flex justify-between items-center border-[#606060] border rounded-lg p-2 sm:p-5 w-full max-w-[450px]">
                      ...
                      <button
                        className="bg-[#F7F8F9] dark:bg-[#242424] dark:text-white h-fit py-1 px-2 rounded-sm flex gap-2 items-center"
                        disabled
                      >
                        <span className="text-sm">Linked</span>
                      </button>
              ...
              <div className="mb-8">
                ...
                <div className="flex gap-6">
                  {user.email ? (
                    <div className="flex gap-2 justify-between items-center border-[#606060] border rounded-lg p-2 sm:p-5 w-full max-w-[450px]">
                      <div className="flex gap-3 items-center">
                        <Image
                      ...
                      <button
                        className="bg-[#F7F8F9] dark:bg-[#242424] dark:text-white dark:bg-[#242424] dark:text-white h-fit py-1 px-2 rounded-sm flex gap-2 items-center"
                        disabled
                      >
                        <span className="text-sm">Linked</span>
                      </button>
