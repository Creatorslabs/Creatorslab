...
import CustomModal from "@/src/app/components/Modals/custom-modal";
...
const { connectWallet } = useConnectWallet({
  ...
  useEffect(() => {
    if (emailState === "awaiting-code-input" && !canResend) {
            ...
            <div className="w-full py-2">
              {emailState === "awaiting-code-input" ? (
                <>
                  ...
                  <button
                    aria-label={loading ? "Processing login" : "Login"}
                    ...
                    disabled={isSubmittingOtp || codeEmail.length !== 6}
                  >
                    {isSubmittingOtp ? (
                      <>
                        <Spinner />
                ...
                <>
                  ...
                  <button
                    ...
                    disabled={emailState !== "initial" || !email || loading}
                  >
                    {emailState !== "initial" ? (
                      <>
                        <Spinner />
