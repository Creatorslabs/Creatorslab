...
const SideBar: React.FC = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 h-screen transition-all duration-300 bg-[#212121] z-50
      ...
      <div className='flex flex-col justify-between h-[calc(100vh-100px)] p-4'>
        <nav>
          <ul>
                ...
                <li key={index} className="mb-4 relative group">
                  ...
                  >
                    <Image
                      ...
                      alt={`${item.label} icon`}
                    />
                    <span className={`text-sm ${isCollapsed ? 'hidden md:block' : 'block'}`}>
                      {item.label}
                    </span>
